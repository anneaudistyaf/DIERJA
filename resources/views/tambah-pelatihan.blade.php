                            ...
                            <div class="col-sm-4">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="file" accept="video/mp4" class="form-control-file" id="teaser">
                            ...
                            <div class="col-sm-4">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <h5>Upload Video</h5>
                                        <label for="exampleFormControlFile1">Choose file</label> <br>
                                        <input type="file" accept="video/mp4" class="form-control-file" id="pelatihan">
                                        <p>Acceptable format : mp4 only
                                            max size is 60mb and min size is 2mb</p>
                                    </div>
                                  </form>
