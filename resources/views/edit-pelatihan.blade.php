            ...
            <div class="card">
                ...
                <form action="{{route('admin.update.pelatihan',$pelatihan->pelatihan_id)}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="judul" type="text" value="{{$pelatihan->judul}}" class="form-control"
                                id="namapelatihan">
                        </div>
                        <div class="col-sm-1"></div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="author" type="text" value="{{$pelatihan->author}}" class="form-control"
                                id="pembuat">
                        </div>
                        <div class="col-sm-1"></div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1"
                                rows="3">{{$pelatihan->deskripsi}}</textarea>
                        </div>
