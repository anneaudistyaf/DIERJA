            ...
            <div class="col-sm-4">
                <form>
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control border-secondary" id="formGroupName" placeholder="Nama Lengkap">
                    </div>
                    <br>
                    <div class="form-group">
                      <input type="email" class="form-control border-secondary" id="formGroupEmail" placeholder="Email">
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="password" class="form-control border-secondary" id="formGroupPassword" placeholder="Kata Sandi">
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="password" class="form-control border-secondary" id="formGroupConfirmPassword" placeholder="Konfirmasi Kata Sandi">
                    </div>
                    <br>
                    <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            <input type="email" class="form-control border-secondary" id="formGroupEmail2" placeholder="Email">
                          </div>
                          <br>
                          <div class="form-group">
                              <input type="password" class="form-control border-secondary" id="formGroupPassword2" placeholder="Kata Sandi">
                          </div>
                          <br>
                          <div class="text-center">
