    ...
    <div class="home-sharing">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <br>
                <a class="btn btn-primary btn-link" data-toggle="modal" href="#exampleModalCenter" role="button">Tulis Pengalaman</a>
            </div>
            <div class="col-md-1"></div>
        </div>
    </div>
            ...
            <div class="card-columns">
                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card border-secondary">Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum</p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            ...
            <div class="modal-body text-center">
                <from>
                    ...
                    <textarea name="isisharing" id="" cols="50" rows="10"></textarea>
                    <br>
