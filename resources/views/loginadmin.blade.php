...
<body>
    ...
    <div class="row login-admin">
        ...
        <div class="col-md-4">
            ...
            <br>
            <form method="POST" action="{{route('admin.login.action')}}" id="">
                @csrf
                <div class="form-group">
                    <input type="email" name="email" class="form-control border-secondary" id="formGroupEmail2"
                        placeholder="Email">
                </div>
                <br>
                <div class="form-group">
                    <input type="password" name="password" class="form-control border-secondary" id="formGroupPassword2"
