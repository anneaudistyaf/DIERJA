    ...
    <div class="row comp-detail">
        ...
        <div class="col-md-6">
            ...
            <div class="d-grid gap-2 d-md-block">
                <a href="{{route('company.edit-perusahaan',$company->company_id)}}" class="btn btn-primary text-center">Edit profile</a>
                <a href="{{route('company.lowongan-perusahaan')}}" class="btn btn-primary text-center">Lowongan</a>
                <a href="{{route('company.lamaran.perusahaan')}}" class="btn btn-primary text-center">Apply lamaran</a>
            </div>
        </div>
        <div class="col-md-3"></div>
    </div>
